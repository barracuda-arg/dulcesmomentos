                    ...
                    <main className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                        <div className="flex-1 rounded-br-lg rounded-bl-lg bg-white p-6 pb-12 text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-tl-lg lg:rounded-br-none lg:p-20 dark:bg-[#161615] dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]">
                            ...
                            <p className="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                                ...
                                <h1 className="bg-blue-500 text-white p-4 rounded-xl">
                                    Probando Tailwind v4 en Dulces Momentos
                                </h1>

                            </p>
                            <div className="min-h-screen bg-pasteleria-claro p-8">
                                <h1 className="text-4xl font-bold text-pasteleria-rosa">
                                    Bienvenidos a Dulces Momentos
                                </h1>
                                <button className="mt-4 bg-pasteleria-rosa text-white px-6 py-2 rounded-full shadow-lg hover:opacity-90 transition">
                                    Ver Catálogo
                                </button>
                            </div>
